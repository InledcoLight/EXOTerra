...
public abstract class HomeDevicesAdapter extends RecyclerView.Adapter<HomeDevicesAdapter.HomeDevicesViewHolder> {
    private Context mContext;
    private List<HomeApi.HomeDevicesResponse.Device> mDevices;

    public HomeDevicesAdapter(@NonNull final Context context, List<HomeApi.HomeDevicesResponse.Device> devices) {
        mContext = context;
        mDevices = devices;
    }

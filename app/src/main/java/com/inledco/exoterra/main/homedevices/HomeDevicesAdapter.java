...
public class HomeDevicesAdapter extends SimpleAdapter<RoomDevice, DeviceViewHolder> {

    public HomeDevicesAdapter(@NonNull Context context, List<RoomDevice> data) {
        super(context, data);
    }

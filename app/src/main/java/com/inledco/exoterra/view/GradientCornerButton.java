...
public class GradientCornerButton extends android.support.v7.widget.AppCompatButton {
    ...
    public GradientCornerButton(Context context) {
        this(context, null, 0);
    }

    public GradientCornerButton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientCornerButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

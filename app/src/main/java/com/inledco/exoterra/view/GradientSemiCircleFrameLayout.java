...
public class GradientSemiCircleFrameLayout extends FrameLayout {
    private int mGradientStart;
    private int mGradientEnd;

    private Paint mPaint;

    public GradientSemiCircleFrameLayout(Context context) {
        this(context, null, 0);
    }

    public GradientSemiCircleFrameLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientSemiCircleFrameLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

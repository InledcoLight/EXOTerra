...
public class ChartHelper {
    ...
    public static void initLineChart(@NonNull LineChart chart) {
    ...
    public static void initBarChart(@NonNull BarChart barChart) {
        ...
        xAxis.setTextColor(Color.WHITE);
        xAxis.setAxisMaximum(barChart.getContext().getResources().getInteger(R.integer.spectrum_wavelength_max));
        xAxis.setAxisMinimum(barChart.getContext().getResources().getInteger(R.integer.spectrum_wavelength_min));
